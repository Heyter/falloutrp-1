...
-- Door positions and destinations table for rp_lazarus_newvegas_day_beta
	...
	rp_falloutnewvegas = {
		...
		destinfo = {
			...
			[149] = {pos = Vector("-4348.432617 6854.285156 7504.455078"), angs = Angle("-0.034 90.202 89.883"), uid = "verygenericfreesidebuilding_e"},
		...
		linkData = {
			...
			{114, 115},
			{65, 66},
			{107, 108, 109, 110, 112, 117, 118, 119, 120, 121, 113},
			{143, 144, 150, 151},
			{148, 145, 147, 146, 142, 141, 140, 139, 149},
			{128, 127},
			{130, 125},
			{131, 124},
			{132, 123},
			...
			{111, 106},
			{3, 6},
			{156, 155, 152, 153, 154, 159, 158, 161, 160},
			{178, 179}
